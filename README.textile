...
nohup ./zk-chaos.py --servers "localhost:2181" --root_znode="/zk-latencies_9" --znode_count=1000 --znode_size=100 --synchronous &
nohup ./zk-chaos.py --servers "localhost:2181" --root_znode="/zk-latencies_5" --znode_count=10000 --znode_size=100 --synchronous &
